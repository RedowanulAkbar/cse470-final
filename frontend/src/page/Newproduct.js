    ...
    <div className="p-4">
      ...
      >
        ...
        >
          ...
          <option value={"chewyCandy"}>Chewy Candy</option>
          <option value={"sourCandy"}>Sour Candy</option>
          <option value={"savorySnacks"}>Savory Snacks</option>
          <option value={"sweetSnacks"}>Sweet Snacks</option>
          <option value={"animeSnacks"}>Anime Snacks</option>
          <option value={"seasonalSnacks"}>Seasonal Snacks</option>
          <option value={"chocolateSnacks"}>Chocolate Snacks</option>
